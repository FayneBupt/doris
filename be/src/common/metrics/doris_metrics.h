...
public:
    ...
    IntCounter* paimon_partition_writer_created = nullptr;
    IntCounter* paimon_prepare_commit_messages = nullptr;
    IntCounter* paimon_commit_payload_chunks = nullptr;
    IntCounter* paimon_commit_payload_bytes = nullptr;
    HistogramMetric* paimon_write_send_data_latency_ms = nullptr;
    HistogramMetric* paimon_write_project_latency_ms = nullptr;
    HistogramMetric* paimon_write_bucket_calc_latency_ms = nullptr;
    HistogramMetric* paimon_write_dispatch_latency_ms = nullptr;
    HistogramMetric* paimon_write_partitions_latency_ms = nullptr;
